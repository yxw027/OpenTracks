    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.track_detail_share:
                intent = IntentUtils.newShareFileIntent(this, new long[]{track.getId()});
                intent = Intent.createChooser(intent, null);
                startActivity(intent);
                return true;
            case R.id.track_detail_menu_show_on_map:
                IntentDashboardUtils.startDashboard(this, new long[]{track.getId()}, false);
                return true;
            ...
            case R.id.track_detail_delete:
                deleteTracks(new long[]{track.getId()});
                return true;
